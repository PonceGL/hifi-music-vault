...
export function MusicTable({
  ...
  const allSelected =
    ...
    filteredData.every((item) => selectedTracks.has(item.file));
  const isIndeterminate =
    filteredData.some((item) => selectedTracks.has(item.file)) && !allSelected;
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              {showPlaylistsColumn && (
                <TableHead className="w-[200px]">Playlists</TableHead>
              )}
